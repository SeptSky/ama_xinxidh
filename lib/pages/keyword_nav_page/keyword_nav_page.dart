...
import 'filter_list_adapter/filter_list_adapter.dart';
import 'keyword_nav_effect.dart';
import 'keyword_nav_reducer.dart';
import 'keyword_nav_state.dart';
import 'keyword_nav_view.dart';

class KeywordNavPage extends Page<KeywordNavPageState, Map<String, dynamic>> {
  ...
  KeywordNavPage()
      : super(
          ...
          dependencies: Dependencies<KeywordNavPageState>(
            /// adapter对接数据列表子组件
            adapter: NoneConn<KeywordNavPageState>() + FilterListAdapter(),
